...
const Navbar = () => {
  const activeNavStyle =
    "after:content-[''] after:absolute after:right-0 after:bottom-0 after:h-[50%] after:translate-y-[-50%] after:w-[0.2rem] after:bg-white md:after:translate-y-0 md:after:bottom-0 md:after:left-[48%] md:after:translate-x-[-50%] md:after:w-[100%] md:after:h-[0.1rem] md:after:bg-white lg:after:h-[0.2rem]";
  ...
  return (
    <nav className="mt-[3.2rem] md:mt-0 md:pr-[0.5rem]">
      <ul className="uppercase font-barlow-con text-left pl-[1.1rem] tracking-[0.2em] md:flex md:gap-[2.3rem] md:tracking-[0.13em] lg:gap-[4.3rem]">
        <li className="py-[0.8rem] relative md:text-[0.9rem] lg:py-[2rem]">
          <NavLink
            to="/"
            className={({ isActive }) =>
